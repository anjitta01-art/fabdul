...
<head>
    ...
    <title>Edit User Details - Fabdul Rentals</title>
...
<body>
        ...
        <main class="pt-[74px]">
            <div class="flex relative">
                ...
                <div class="p-10 w-full">
                    <h1 class="text-3xl font-bold mb-6">Edit User Details</h1>
                    <p class="text-gray-600 pb-4">Edit the user's information below.</p>
                    <form id="edit-user-form" class="bg-white p-6 rounded-lg shadow-md space-y-4 max-w-3xl">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-start">
                                <button type="submit" id="update-details-btn" class="bg-purple-700 text-white py-2 px-4 rounded-md hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer">Update Details</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script src="../../public/js/admin/users/edit-details.js"></script>
</body>
</html>